...
namespace Crab2012
{
    class Borne
    {
      ...
      // TimeSpan
        ...
        /// </summary>
        /// <returns></returns>
        public int getDureeRevision() { return this.leType.getDureeRevision(); }
        /// <summary>
        ...
        {
            bool aReviser = false; 
            TimeSpan dif = DateTime.Now.Subtract(this.dateDerniereRevision);
            double nbJours = dif.TotalDays;
            if(nbJours > 0   || this.indiceCompteurUnites > this.leType.getNbUnitesEntreRevisions())
            {
                aReviser = true;
            }
